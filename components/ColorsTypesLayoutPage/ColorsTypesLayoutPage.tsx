...
import { colors, types } from './ColorsTypesLayoutPage.data.json';
import * as S from './ColorsTypesLayoutPage.styles';

const ColorsTypesLayoutPage: React.FC = () => (
  <S.ColorsTypesLayout>
    <S.Logo>
      <UILogo />
    </S.Logo>
...
export default ColorsTypesLayoutPage;
