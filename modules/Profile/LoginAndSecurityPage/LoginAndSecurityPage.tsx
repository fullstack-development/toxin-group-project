...
const LoginAndSecurityPage = memo(({ isAuthSuccess, checkAuthBeforePageLoaded }: Props) => {
...
const ConnectedComponent = connect(mapState, mapDispatch)(LoginAndSecurityPage);
export { ConnectedComponent as LoginAndSecurityPage };
